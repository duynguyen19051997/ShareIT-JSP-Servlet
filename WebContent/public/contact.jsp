            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="blog-sidebar-area">
                        ...
                        <div class="treading-articles-widget mb-70">
                            ...
                            <div class="single-blog-post style-4">
                                ...
                                <div class="post-thumb">
                                    <a href="#"><img src="<%=request.getContextPath()%>/templates/public/img/bg-img/15.jpg" alt=""></a>
                            ...
                            <div class="single-blog-post style-4">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <a href="#"><img src="<%=request.getContextPath()%>/templates/public/img/bg-img/16.jpg" alt=""></a>
                            ...
                            <div class="single-blog-post style-4">
                                <!-- Post Thumb -->
                                <div class="post-thumb">
                                    <a href="#"><img src="<%=request.getContextPath()%>/templates/public/img/bg-img/17.jpg" alt=""></a>
                        ...
                        <!-- Add Widget -->
                        <div class="add-widget">
                            <a href="#"><img src="<%=request.getContextPath()%>/templates/public/img/bg-img/add.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
