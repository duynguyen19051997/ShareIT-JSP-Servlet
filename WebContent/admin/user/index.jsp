                                	...
                                	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                        	...
                                        	<tr class="odd gradeA">
                                        		...
                                        		%>
                                        		<td class="center"">
                                        			<a href="<%=request.getContextPath()%>/admin/user/edit?id=<%=objUser.getId() %>&page=<%=currentPages %>" title="Sửa"><button type="button" class="btn btn-outline btn-primary">Sửa</button></a>
                                           		 <%
                                            		if(objUser.getId() != 3){
                                           		 %>	
                                           			 <a onclick="return confirm('Bạn có muốn chắc chắn xóa không?')" href="<%=request.getContextPath()%>/admin/cat/delete?id=<%=objUser.getId() %>&page=<%=currentPages %>" title="Xóa"><button type="button" class="btn btn-outline btn-danger">Xóa</button></a>
                                        		<%	} %>
                                        		</td>
                                       			 <%	}else{ %>
                                        		<td class="center">
